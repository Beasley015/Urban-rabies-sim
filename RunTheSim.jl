...
lam1 = [0.0143, 0.0224, 0.0349, 0.0543, 0.0847, 0.132]
#lam2 = [0.001, 0.002, 0.003, 0.004, 0.005]
...
# Create filename
filename = "disease_test_l1.csv"#string("sero",string(Params[!,1][1]),"im_rate",string(Params[!,2][1]),"im_dis",string(Params[!,3][1]),
